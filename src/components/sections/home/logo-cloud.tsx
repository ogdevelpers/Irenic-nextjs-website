          ...
          <div className="relative py-6 md:w-[calc(100%-11rem)]">
            <InfiniteSlider speedOnHover={20} speed={40} gap={100}>
              <div className="flex">
                ...
                <img src="https://irenicevents.com/images/clients/birla-opus-paints.png" alt="Logo 1" width={100} height={100} />
              </div>
              ...
              <div className="flex">
                ...
                <img src="https://irenicevents.com/images/clients/pidilite.png" alt="Logo 1" width={100} height={100} />
              </div>
              <div className="flex">
                {/* <svg
                  className="size-12"
                ...
                <img src="https://irenicevents.com/images/clients/jsw-cement.png" alt="Logo 1" width={100} height={100} />
              </div>
              <div className="flex">
                {/* <svg
                  className="size-12"
                ...
                <img src="https://irenicevents.com/images/clients/arvind.png" alt="Logo 1" width={100} height={100} />
              </div>
              <div className="flex">
                {/* <svg
                  className="size-12"
                ...
                <img src="https://irenicevents.com/images/clients/perfios.png" alt="Logo 1" width={100} height={100} />
              </div>
              <div className="flex">
                {/* <svg
                  className="size-12"
                ...
                <img src="https://irenicevents.com/images/clients/mercedes-benz.png" alt="Logo 1" width={100} height={100} />
              </div>
              <div className="flex">
                {/* <svg
                  className="size-12"
                ...
                <img src="https://irenicevents.com/images/clients/policy-bazaar.png" alt="Logo 1" width={100} height={100} />
              </div>

                <div className="flex">
                  <img src="https://irenicevents.com/images/clients/neo-growth.png" alt="Logo 1" width={100} height={100} />
                </div>
                <div className="flex">
                  <img src="https://irenicevents.com/images/clients/lowes.png" alt="Logo 1" width={100} height={100} />
                </div>
                <div className="flex">
                  <img src="	https://irenicevents.com/images/clients/hafele.png" alt="Logo 1" width={100} height={100} />
                </div>
                <div className="flex">
                  <img src="https://irenicevents.com/images/clients/pbpartners.png" alt="Logo 1" width={100} height={100} />
                </div>
                <div className="flex">
                  <img src="https://irenicevents.com/images/clients/indo-space.png" alt="Logo 1" width={100} height={100} />
                </div>
            </InfiniteSlider>
